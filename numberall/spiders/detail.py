...
class DetailSpider(scrapy.Spider):
    ...
    start_urls = ['https://hf.fang.anjuke.com/loupan/431014.html?from=AF_RANK_1']
    ...
    def parse_huxing_detail(self, response):
        ...
        img_url = response.xpath("//li[@class='item pic-item']/img/@imglazyload-src").extract_first().replace('.jpg','a.jpg')
        ...
        self.bucket.put_object('20000101/' + image_name + '.jpg', input1)
        # TODO 以上代码已顺利传送图片进oss服务器.需要用上传入相应的"小区:oss链接"进数据库

        oss_u = "http://img.df-house.com/20000101/"
        item['oss_url'] = oss_u + img_url.split('/')[-2] + ".jpg"
